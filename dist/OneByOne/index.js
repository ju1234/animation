...
},{"./_to-absolute-index":45,"./_to-iobject":47,"./_to-length":48}],11:[function(require,module,exports){
...
},{"./_core":13,"./_ctx":14,"./_global":21,"./_has":22,"./_hide":23}],20:[function(require,module,exports){
...
},{"./_export":19,"./_hide":23,"./_iter-create":28,"./_iterators":31,"./_library":32,"./_object-gpo":36,"./_redefine":40,"./_set-to-string-tag":41,"./_wks":52}],30:[function(require,module,exports){
...
},{"./_core":13,"./_global":21,"./_library":32}],44:[function(require,module,exports){
...
var Ele = function () {
    function Ele(tagName, classList) {
        (0, _classCallCheck3.default)(this, Ele);

        this.el = document.createElement(tagName);
        this.el.classList.add(classList);
    }

    (0, _createClass3.default)(Ele, [{
        key: 'fadeIn',
...
window.onload = function () {
    var defaultValue = 'password'.split('');
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;

    try {
        for (var _iterator = (0, _getIterator3.default)(defaultValue), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function appendNewInput() {
    ...
    var input = new Input(type, value);
